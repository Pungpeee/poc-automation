        ...
        <>
          ...
          >
            ...
            >
              ...
              <Box width="100%" height="110px" marginTop="39px" sx={{ borderRadius: "8px" }}>
                <Image src="/Large_Leaderboard_1.png" width="1200px" height="110px%" />
              </Box>
            </Box>
          </Box>
          {/* ------------------------------------- Ranking -----------------------------------------------------*/}
          ...
          >
            ...
            <Box
              ...
              px={{ xs: "0px", md: "260px" }}
            >
              <Box width="100%" height="100%" p="32px" sx={{ background: "#FFF", borderRadius: "8px" }}>
                {/* -------------------------------- Header ----------------------------------------------------- */}
                <Box
                  display="flex"
                  flexDirection={{ xs: "column", md: "row" }}
                  ...
                  {/* {rank?.results.map((d) => {
                    return (
                      <RankDisplay
                        ...
                        comp="scg"
                        name={d?.full_name}
                        co2={d?.total_carbon_saving}
                        email={d?.email}
                        is_me={d?.email == profile?.email}
                        image={d?.image}
                      />
                    )
                  })} */}
                  {/* {MOCK_USER_RANK_2.map(({ rank, image, full_name, email, total_carbon_saving, comp }, index) => {
                    return (
                      <RankDisplay
                        key={rank}
                        rank={rank}
                        ...
                        name={full_name}
                        email={email}
                        co2={total_carbon_saving}
                        is_me={email == "okk@gmail.com"}
                        image={image}
                        index={(index % 3) + 1} //mod เลข
                      />
                    )
                  })} */}
                  {rankCurrent === "main" ? (
                    <div>
                      {rank?.results.map(({ rank, image, full_name, email, total_carbon_saving }) => (
                        <RankDisplay
                          key={rank}
                          rank={rank}
                          name={full_name}
                      ...
                      {myRank?.detail === undefined ? (
                        <RankDisplay
                          ...
                          email={myRank?.emai}
                          co2={myRank?.total_carbon_saving}
                          image={myRank?.image}
                          isTop={false}
                        />
                      ) : (
            ...
            <Box display="flex" height="531px">
              ...
              >
                <Box
                  ...
                  alignItems="center"
                >
                  <Box width="350px" height="254px" display="flex" flexDirection="column">
              ...
              <Box width="50%" height="531px" position={"relative"} overflow={"hidden"}>
            ...
            >
              <Box width="100%" height="100%" py="25px">
                ...
                >
                  ...
                  {rankCurrent === "main" ? (
                    <>
                      {rank?.results.map(({full_name,email,image,rank,total_carbon_saving}) => {
                        return <RankDisplay_new name={full_name} img={image} rank={rank} email={email} carbon={total_carbon_saving}/>
                      })}
                    </>
                  ) : // <div>
                  //   {rank?.results.map(({ rank, image, full_name, email, total_carbon_saving }) => (
...
const RankDisplay2 = ({ name, email, total, r1, r2, co2, rank, image, comp }) => {
  return (
    <Box
      display="flex"
      width="100%"
    ...
    >
      ...
      <Box display="flex" width="55%" alignItems="center" gap={3} paddingLeft="10px">
        <Text type={18} fontWeight={700} color="white" sx={{ width: "5px" }}>
          {rank}
        </Text>
        {image !== "" ? (
          <Box
...
const CarbonSavingDisplay = (props) => {
  const { category, value, isAuth } = props
  return (
    <Box display="flex" flexDirection="column" alignItems="center" sx={{ flex: "0 0 13%" }}>
          ...
          {data[1] !== undefined && (
            <SecondPlace>
              ...
              {data[1].image !== "" ? (
                ...
                <ProfileRank frame={2}>
                  <NameIcon sx={{ width: "119px", height: "119px", position: "absolute" }}>
                    <Text type="25" fontWeight={700}>
...
const NFT_Marketplace = styled(Box)({
  backgroundImage: 'url("Large_Leaderboard_1.png")',
  minHeight: "110px",
  width: "100%",
